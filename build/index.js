...
attributes: {
    ...
    // Nouvel attribut : mode d'affichage de l'image recto
...
attributes: {
                ...
                verticalAlign,
                backBgColor,
                frontImageMode // propagation du nouvel attribut
            },
            setAttributes
        } = props;
...
el('div', {
    className:
        ...
        (frontImageMode === 'picto' ? ' image-mode-picto' : ''), // Ajout classe conditionnelle pour le mode picto
    style: frontImage
        ? (frontImageMode === 'cover'
            ? { backgroundImage: `url(${frontImage})`, backgroundColor: frontBgColor }
            : { backgroundImage: `url(${frontImage})`, backgroundColor: frontBgColor })
...
el(PanelBody, { title: "Image recto", initialOpen: true },
    ...
    // Contrôle du mode d'affichage de l'image recto
    el(SelectControl, {
